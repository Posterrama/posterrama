...
## Critical Architecture Issues (Code-Verified 2025-11-11)
...
**Problem**: 5 endpoints have verbs in their paths (violates REST principles)
...
- REST standard: URLs are **nouns**, actions via HTTP verbs
...
3. Add temporary redirects with `Deprecation` header
