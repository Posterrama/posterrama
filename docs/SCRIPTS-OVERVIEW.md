...
**Total Scripts:** 27 active scripts (after cleanup from 38)

### By Category

| Category                 | Count | Purpose                                  |
| ------------------------ | ----- | ---------------------------------------- |
| **Testing & Validation** | 11    | Test execution, coverage, API validation |
| **Configuration**        | 3     | Config validation and verification       |
| **Maintenance**          | 5     | Cleanup, MQTT, device management         |
| **Build & Deploy**       | 3     | Production deployment, icons, secrets    |
...
- `measure-tiered-cache.js` (POC test)
