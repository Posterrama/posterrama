...
- [ ] Stage batch annotations/removals of remaining empty catch blocks (target ~25 per PR) – Phase 1 (10) + Batch 2 (~20) + Batch 3 (~10) + Batch 4 (~10) + Batch 5 (~10) done in script.js; proceed with Batch 6
