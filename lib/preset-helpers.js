...
// In test environment, bypass any fs mocks to use actual filesystem
// @ts-ignore - jest namespace access in conditional
const fs = (() => {
    try {
        // @ts-ignore - jest namespace check
        return typeof jest !== 'undefined' && jest.requireActual
            ? // @ts-ignore - jest.requireActual
