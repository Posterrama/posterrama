                    ...
                    for (const summary of items) {
                        try {
                            ...
                            results.push({
                                ...
                                // Comprehensive metadata (Phase 1-6: all new fields from processPlexItem)
                                ...
                                contentRatingAge: processed.contentRatingAge || undefined,
                                addedAt: processed.addedAt || undefined,
                                updatedAt: processed.updatedAt || undefined,
                                ultraBlurColors: processed.ultraBlurColors || undefined,
                                ratingsDetailed: processed.ratingsDetailed || undefined,
                                parentalGuidance: processed.parentalGuidance || undefined,
                                chapters: processed.chapters || undefined,
                                markers: processed.markers || undefined,
                                bannerUrl: processed.bannerUrl || undefined,
                                discArtUrl: processed.discArtUrl || undefined,
                                thumbUrl: processed.thumbUrl || undefined,
                                clearArtUrl: processed.clearArtUrl || undefined,
                                landscapeUrl: processed.landscapeUrl || undefined,
                                allArtUrls: processed.allArtUrls || undefined,
                                fanart: processed.fanart || undefined,
                                audioTracks: processed.audioTracks || undefined,
                                subtitles: processed.subtitles || undefined,
                                videoStreams: processed.videoStreams || undefined,
                                hdrFormats: processed.hdrFormats || undefined,
                                hasHDR: processed.hasHDR || undefined,
                                hasDolbyVision: processed.hasDolbyVision || undefined,
                                is3D: processed.is3D || undefined,
                                containerFormat: processed.containerFormat || undefined,
                                totalFileSize: processed.totalFileSize || undefined,
                                totalBitrate: processed.totalBitrate || undefined,
                                optimizedForStreaming: processed.optimizedForStreaming || undefined,
                                ...
                                filePaths: processed.filePaths || undefined,
                                fileDetails: processed.fileDetails || undefined,
                            });
                        } catch (e) {
                            ...
                            try {
                                ...
                                all.push({
                                    ...
                                    optimizedForStreaming:
                                        processed.optimizedForStreaming || undefined,
                                    // Phase 5 enriched fields (Advanced Metadata)
                                    extras: processed.extras || undefined,
                                    related: processed.related || undefined,
                                    themeUrl: processed.themeUrl || undefined,
                                    lockedFields: processed.lockedFields || undefined,
                                    // Phase 6 enriched fields (File & Location Info)
                                    filePaths: processed.filePaths || undefined,
                                    fileDetails: processed.fileDetails || undefined,
                                    // Additional Phase 1-2 fields that were missing
                                    collections: processed.collections || undefined,
                                    audienceRating: processed.audienceRating || undefined,
                                    skipCount: processed.skipCount || undefined,
                                    userRating: processed.userRating || undefined,
...
// RATING UTILITIES
// ============================================================================
// Ratings functionality extracted to utils/ratings.js for better modularity
