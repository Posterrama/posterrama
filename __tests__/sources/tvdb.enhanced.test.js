...
describe('TVDBSource Enhanced Coverage', () => {
    ...
    describe('Movie Processing Edge Cases', () => {
        ...
        test('should handle different category parameters', async () => {
            const categories = ['recently_added', 'newest', 'popular', 'top_rated', 'trending', 'alphabetical', 'oldest', 'unknown'];
    ...
    describe('Utility Functions', () => {
        ...
        test('should handle different image URL formats', () => {
            ...
            expect(src.getImageUrl('https://secure.url/image.jpg')).toBe('https://secure.url/image.jpg');
    ...
    describe('Integration Scenarios', () => {
        test('should handle complete movie workflow with high-quality artwork for top items', async () => {
            ...
            expect(movies[0].backgroundUrl).toBe('https://artworks.thetvdb.com/high-quality-fanart.jpg');
            expect(movies[0].posterUrl).toBe('https://artworks.thetvdb.com/high-quality-poster.jpg');
        });
