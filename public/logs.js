document.addEventListener('DOMContentLoaded', () => {
    ...
    // DEBUG: Add debug function to check element dimensions and positions
    window.debugBadgeAlignment = function () {
        const searchWrap = document.querySelector('.logs-search-wrap');
        const searchInput = document.querySelector('.logs-search-wrap > input');
        const filterBadges = document.querySelector('.filter-badges');
        const badge = document.querySelector('.filter-badge');

        console.log('=== BADGE ALIGNMENT DEBUG ===');

        if (searchWrap) {
            const searchRect = searchWrap.getBoundingClientRect();
            const searchStyles = window.getComputedStyle(searchWrap);
            console.log('Search Wrap:', {
                height: searchRect.height,
                display: searchStyles.display,
                alignItems: searchStyles.alignItems,
                paddingTop: searchStyles.paddingTop,
        ...
        if (filterBadges) {
            const badgesRect = filterBadges.getBoundingClientRect();
            const badgesStyles = window.getComputedStyle(filterBadges);
            console.log('Filter Badges Container:', {
                height: badgesRect.height,
                display: badgesStyles.display,
                alignItems: badgesStyles.alignItems,
            });
        }
        ...
        if (badge) {
            ...
            console.log('Individual Badge:', {
                height: badgeRect.height,
                paddingTop: badgeStyles.paddingTop,
                paddingBottom: badgeStyles.paddingBottom,
                lineHeight: badgeStyles.lineHeight,
                fontSize: badgeStyles.fontSize,
                alignSelf: badgeStyles.alignSelf,
                boxSizing: badgeStyles.boxSizing,
            });
        }
